        ...
        actions: [Column(
          ...
          children: [
           // Text(id,style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),),
            IconButton(onPressed: (){ Share.share(id);}, icon:Icon(Icons.share) )
          ],
        )],
      ),
      body:SafeArea(
                     ...
                     Positioned(child: Column(
                       ...
                       children: [
                         Card(child: Padding(
                           ...
                           child: Row(children: <Widget>[Text("latitude:${lat.toStringAsFixed(3)}", style: TextStyle(fontSize: 20),), Text("  longitude:${lang.toStringAsFixed(3)}", style: TextStyle(fontSize: 20))],),
                         )),
                         Card(child: Padding(
                           padding: const EdgeInsets.all(8.0),
                           child: Row(children: <Widget>[Text("Speed:${speed.toStringAsFixed(3)}", style: TextStyle(fontSize: 20),), Text("  Altitude:${altitude.toStringAsFixed(3)}", style: TextStyle(fontSize: 20))],),
                         )),
                       ],
                     ), top: 10, right: 10,
)
